...
(function (global, factory) {
  ...
  exports.HueCharacteristic = undefined;

  class HueCharacteristic extends _base.TuyaWebCharacteristic {
    ...
    updateValue(data, callback) {
      ...
      var stateValue = HueCharacteristic.DEFAULT_VALUE;

      if ((data === null || data === void 0 ? void 0 : data.color_mode) !== undefined && (data === null || data === void 0 ? void 0 : data.color_mode) in _index.COLOR_MODES && ((_a = data === null || data === void 0 ? void 0 : data.color) === null || _a === void 0 ? void 0 : _a.hue)) {
